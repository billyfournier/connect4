...
//         Agent yellowPlayer = new MyAgent(game, false); // create the red player, any subclass of Agent
...
//         Agent redPlayer = new RandomAgent(game, true); // create the yellow player, any subclass of Agent
//         Agent redPlayer = new BeginnerAgent(game, true); // create the yellow player, any subclass of Agent
